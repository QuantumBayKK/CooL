...
/**
 * Slide 10 — where we start, and why there.
...
export default function S09GTM() {
  return (
    <Slide
      ...
      sub="AI companies in finance, health and legal — the ones losing deals this quarter while security review waits for evidence."
    >
      <Reveal>
