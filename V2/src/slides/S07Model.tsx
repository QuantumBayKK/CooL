...
/**
 * Slide 8 â€” how the money works, as a ladder read top to bottom.
 * Four lines, ordered by commitment, so the land-and-expand motion is visible
 * without a diagram explaining it.
 */

const TIERS = [
  ["Free", "developers install it in an hour â€” this is how we get in"],
    ...
    >
      ...
      <Reveal delay={0.14}>
        <Note tone="live">
          ...
          up â€” never the reason anyone buys.
        </Note>
      </Reveal>
    </Slide>
  );
